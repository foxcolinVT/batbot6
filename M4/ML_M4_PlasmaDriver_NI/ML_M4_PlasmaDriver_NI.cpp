...
void SERCOM_SPI_init(SercomSpi *SPIx, ML_SPI_mode mode){
...
static void ld_setup(uint16_t alt_buffer[num_pages][num_samples], 
...
void setup() {
  ...
  DMAC_CH_intenset(ML_DMAC_CHIRP_LEFT_IN_CH, DMAC_0_IRQn, DMAC_CHINTENSET_SUSP, 0);
  ...
  DMAC_CH_intenset(ML_DMAC_CHIRP_RIGHT_IN_CH, DMAC_1_IRQn, DMAC_CHINTENSET_SUSP, 0);
