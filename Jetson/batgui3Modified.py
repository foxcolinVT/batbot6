...
# =============================================================================
    ...
    def createInfoWidget(self):
        ...
        #MIN = QtWidgets.QSizePolicy.MIN.value
        ...
        self.rateLabel = QtWidgets.QLabel(self.fsString)
    ...
    def createSettings(self):
        ...
        self.highcutLabel = QtWidgets.QLabel('{:.0f} kHz  ----\ '.format(self.highcut*1e-3))
        self.lowcutLabel = QtWidgets.QLabel('/----  {:.0f} kHz'.format(self.lowcut*1e-3))
        self.cutLabel = QtWidgets.QLabel('Band-pass Range')
...
# =============================================================================
        ...
        self.noverlapLabel = QtWidgets.QLabel('overlap: {}%'.format(str(noverlapDisp)))
