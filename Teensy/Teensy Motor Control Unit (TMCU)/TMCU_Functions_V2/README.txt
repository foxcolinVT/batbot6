Teeny Motor Control Units (TMCU)

The TMCUs control both the pan tilt unit and the stepper motors.
...
Two teensies will be used- a left and right one, each with unique opcodes. More on that later.
...
Wiring Connections:
			...
			Pins 20-23:			Right Stepper
												It is possible that we don't end up using the stepper motors.
...
Moving a servo:
	...
	The right teensy operates identically, except it takes an opcode of 0xX5 instead of 0xX2
